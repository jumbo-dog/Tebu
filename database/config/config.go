...
func ConnectDatabase() {
	...
	opts := options.Client().
		ApplyURI("mongodb+srv://" + helper.GetEnvValue("DATABASE_LOGIN", "../../.env") + ":" + helper.GetEnvValue("DATABASE_PASSWORD", "../../.env") + "@cluster0.iwwx7zx.mongodb.net/?retryWrites=true&w=majority").
